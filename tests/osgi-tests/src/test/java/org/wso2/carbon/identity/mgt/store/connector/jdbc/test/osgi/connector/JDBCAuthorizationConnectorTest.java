...
//                .setDomain(new Domain("carbon", 1, UNIQUE_ID_RESOLVER)).build();
//        userList.add(user1);
//
...
//    }
//
//    @Test(priority = 32, expectedExceptions = Exception.class, expectedExceptionsMessageRegExp = "No permission
// found" +
//            " for the given name.*")
