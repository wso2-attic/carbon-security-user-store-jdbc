...
class StoreTests {
    ...
    public StoreTests() throws Exception {
        defaultDomain = new Domain("carbon", 1, UNIQUE_ID_RESOLVER);
    }
    ...
    public Option[] createConfiguration() {
        ...
        optionList.add(mavenBundle()
                ...
                .artifactId("org.wso2.carbon.identity.mgt.connector.jdbc")
                .versionAsInProject());
        optionList.add(mavenBundle()
                .groupId("org.wso2.carbon.security.userstore")
                .artifactId("org.wso2.carbon.security.userstore.authorization.jdbc")
                .versionAsInProject());
        optionList.add(mavenBundle()
