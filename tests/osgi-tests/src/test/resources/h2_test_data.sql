...
VALUES ('3opCozpRixH6BvSXyr0513v1nyFWpdcQy7F6r6P/LFE=', '41dadd2aea6e11e59ce95e5517507c66'),
  ...
  ('3opCozpRixH6BvSXyr0513v1nyFWpdcQy7F6r6P/LFE=', 'admin');

INSERT INTO UM_PASSWORD_INFO (PASSWORD_SALT, HASH_ALGO, ITERATION_COUNT, KEY_LENGTH, USER_ID)
VALUES ('1ff1188e-f1bf-11e5-9ce9-5e5517507c66', 'SHA256', 4096, 256, (SELECT ID FROM UM_PASSWORD WHERE USER_UNIQUE_ID = '41dadd2aea6e11e59ce95e5517507c66')),
  ('1ff1188e-f1bf-11e5-9ce9-5e5517507c66', 'SHA256', 4096, 256, (SELECT ID FROM UM_PASSWORD WHERE USER_UNIQUE_ID = 'admin'));
